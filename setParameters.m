...
par.letterKeys = [KbName('q') KbName('w') KbName('e') KbName('r') ...
    KbName('t') KbName('y') KbName('u') KbName('i') ...
    KbName('o') KbName('p') KbName('a') KbName('s') ...
    KbName('d') KbName('f') KbName('g') KbName('h') ...
    KbName('j') KbName('k') KbName('l') KbName('z') ...
    KbName('x') KbName('c') KbName('v') KbName('b') ...
    KbName('n') KbName('m')] 
